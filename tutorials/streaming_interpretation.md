...
This page is a continuation of the [single-module](streaming_single_module.md)- and [multi-module streaming](streaming_multi_module.md) tutorials.

It shows how to process `.stream` files generated by the streaming tutorials, produce time- and frequency-domain plots, and extract other types of data including overload information.

Note that the example code shown on this page does not support CAN measurements made with the Type 3058 module. Refer to the [BE-1872 reference manual](../doc/be187215.pdf) for information on how to extend the code to support CAN measurements.
